...
function calcular(s1,s2,q1,qx,q2,hj,hw1,hw2){
  ...
  const mejor=pH>0.55?"Victoria "+s1.n:pA>0.55?"Victoria "+s2.n:(pH+pD)>0.75?"Doble 1X":(pA+pD)>0.75?"Doble X2":m15>0.72?"Mas 1.5 goles":"Evalua con cuotas";
      ...
      <div style={{padding:12}}>
        {tab==="pred"&&<div>
          <div style={card}>
            ...
            {pr?.alerta&&<div style={{background:"#ff303010",borderRadius:8,padding:10,marginBottom:12,border:"2px solid #ff6060"}}><div style={{fontSize:9,color:"#ff6060",fontWeight:800,marginBottom:3}}>ALERTA BLOQUE</div><div style={{fontSize:11,color:"#fca5a5",lineHeight:1.5}}>Patron confirmado: Espana 0-0 Cabo Verde, Belgica 1-1 Egipto, Brasil 1-1 Marruecos, Iran 2-2 NZ. Usa Doble Oportunidad.</div></div>}
